...
public class dataSourceAticleWeek {
	...
	public static List<String> getData() {
		...
		int[] pageNum = { 4,4,
				...
				4,4
						 ...
						 * { 10, 20, 30, 10, 20, 20, 20, 20, 20, 20, 20, 20, 30 };
						 */
		int i;
	...
	public static List<String> getAnser(String url, int type) throws IOException, InterruptedException {
