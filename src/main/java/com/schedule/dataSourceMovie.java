...
public class dataSourceMovie
{
    ...
    throws IOException, InterruptedException
  {
    ...
    for (String s : rusltAnser)
    {
      ...
      String sql2 = "INSERT INTO `aticle` ( `atman`, `attitle`, `atcontext`, `atdate`, `atlabel`, `atstate`) VALUES ( 'admin','" + split[1] + "', '" + split[0] + split[2] + "', now(), '1', '0');";
      sqlList.add(sql2);
  ...
  public static void getAnser(String url, int type)
    throws IOException, InterruptedException
  {
    ...
    throws IOException, InterruptedException
  {
    ...
    String baidupanpath = "����������";String text = "* ";String text2 = "^_^";
    if (parse != null)
    {
  ...
  private static List<String> getHtml()
    throws IOException
  {
    Document doc = null;
    try
